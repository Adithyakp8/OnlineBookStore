...
<link href="/css/admin/editBook.css" rel="stylesheet" type="text/css">
</head>
<body>
...
<div class="main" align="center">
    ...
    <label style="float: left;"for="bookPdf">Upload Book:&emsp;&emsp;&ensp;</label>
    <input type="file" name="bookPdf"/><br /><br>
    <button formaction="updateBook" type="submit" value="Update">Update</button>
    <button formaction="deleteBook" type="submit" value="Delete">Delete</button>
    <button formaction="viewBook" type="submit" value="viewBook">ViewBook</button>
    </fieldset>
  </form:form>
</div>
